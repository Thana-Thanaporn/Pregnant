...
//                ArrayAdapter<String> weekAdapter = new ArrayAdapter<String>(NoteMotherActivity.this, R.layout.spinner_text_item,week);
//                spiSelectWeek.setAdapter(weekAdapter);
    ...
    public void  getData(){
        ...
        reference1.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                if (fav.equals("yes")) {
                    createImage(imgPath, date, favPic,"fav");
                    if (!imgPath2.equals("")) {
                        createImage(imgPath2.substring(1, imgPath2.length()), date, favPic,"fav");
                    }
                }else {
                    createImage(imgPath, date, boxPic,"box");
                    if (!imgPath2.equals("")) {
                        createImage(imgPath2.substring(1, imgPath2.length()), date, boxPic,"box");
                    }
                }
    ...
    public  void createImage(String imgPath , String note , RelativeLayout layout ,String status){
        int countpic =0;
        switch (status){
            case "fav":
    ...
    public void onClickButtomMenu(View v){
        ...
        switch (v.getId()){
            case R.id.btnCalender:
                startActivity(new Intent(NoteMotherActivity.this,MainActivity.class));
                break;
            case R.id.btnHome:
                startActivity(new Intent(NoteMotherActivity.this,HomeActivity.class));
                break;
            case R.id.btnCall:
                startActivity(new Intent(NoteMotherActivity.this,MainActivity.class));
                break;
