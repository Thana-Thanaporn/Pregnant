        ...
        referenceWeek.child("recommends").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                for(DataSnapshot ds : snapshot.getChildren()) {
                    ...
                    TextView txtDetail = new TextView(HomeActivity.this);
                    RelativeLayout.LayoutParams txtDetailparams = new RelativeLayout.LayoutParams(
                            RelativeLayout.LayoutParams.MATCH_PARENT,
                            RelativeLayout.LayoutParams.WRAP_CONTENT
                    );
                    Typeface type = ResourcesCompat.getFont(HomeActivity.this, R.font.kanit_light);
    ...
    public void onClickButtomMenu(View v){
        ...
        switch (v.getId()){
            ...
            case R.id.btnMenuNote:
                startActivity(new Intent(HomeActivity.this,NoteMotherActivity.class));
                break;
            case R.id.btnCall:
                startActivity(new Intent(HomeActivity.this,MainActivity.class));
                break;
